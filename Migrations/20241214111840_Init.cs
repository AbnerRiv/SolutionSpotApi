    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FurnitureColors", x => new { x.FurnitureId, x.ColorId });
                    table.ForeignKey(
                        name: "FK_FurnitureColors_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FurnitureColors_Furnitures_FurnitureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FurnitureColors_ColorId",
